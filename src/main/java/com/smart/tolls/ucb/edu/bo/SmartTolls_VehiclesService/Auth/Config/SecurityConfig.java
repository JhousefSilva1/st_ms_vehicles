...
//                        for color
                                ...
                                .requestMatchers(HttpMethod.PUT, "/api/colors/update/{id}").permitAll()
                                .requestMatchers(HttpMethod.DELETE, "/api/colors/delete/{id}").permitAll()
//                        for brands
                                ...
                                .requestMatchers(HttpMethod.PUT,"/api/brands/update/{id}").permitAll()
                                .requestMatchers(HttpMethod.DELETE,"/api/brands/delete/{id}").permitAll()
...
//                        for models
                                ...
                                .requestMatchers(HttpMethod.PUT,"/api/models/update/{id}").permitAll()
                                .requestMatchers(HttpMethod.DELETE,"/api/models/delete/{id}").permitAll()
...
//                        for FuelTypes
                                ...
                                .requestMatchers(HttpMethod.PUT,"/api/fuelTypes/update/{id}").permitAll()
                                .requestMatchers(HttpMethod.DELETE,"/api/fuelTypes/delete/{id}").permitAll()
//                        for VehiclesType
                                ...
                                .requestMatchers(HttpMethod.PUT,"/api/vehicleType/update/{id}").permitAll()
                                .requestMatchers(HttpMethod.DELETE,"/api/vehicleType/delete/{id}").permitAll()
//                        for vehicles
